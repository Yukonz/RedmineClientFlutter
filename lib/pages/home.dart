  ...
  Widget build(BuildContext context) {
    ...
    switch (appProvider.showPageID) {
      ...
      case 2:
        ...
        break;
      default:
        throw UnimplementedError('No page added for ${appProvider.showPageID}');
    }
      ...
      for (var i = 0; i < mainMenuItems.length; i++) {
        list.add(
          ListTile(
            ...
            selected: appProvider.showPageID == i,
            onTap: () {
          ...
          child: AlertDialog(
            ...
            actions: <Widget>[
              TextButton(
                child: const Text('OK'),
                onPressed: () {
                  appProvider.setCurrentPage(appProvider.showPageID);
                },
              ),
            ],
          ));
